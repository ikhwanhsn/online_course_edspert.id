        ...
        <div className="">
            <div className="flex flex-col gap-5 p-5 pb-3 text-gray-600 md:px-12 md:py-8 md:flex-row md:justify-between">
                <div className="md:basis-3/6">
                    <h1 className="mb-1 font-bold text-gray-700">#UpgradeSkill Bersama Edspert</h1>
                    <p className="text-sm">Jl. Watugede No.58, Wonorejo, Sariharjo, Kec. Ngaglik, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55581</p>
                </div>
                <div className="flex justify-between md:basis-2/6 md:justify-around">
                    <div className="">
                ...
                <div className="md:basis-1/6">
                    <h2 className="mb-1 font-bold text-gray-700">Tentang edspert</h2>
                    <ul className="text-sm md:leading-loose">
